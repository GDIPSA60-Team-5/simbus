...
import iss.nus.edu.sg.feature_saveroute.CommutePlanApi
...
object NetworkProvider {
    ...
    @Provides
    @Singleton
    fun provideCommutePlanApi(retrofit: Retrofit): CommutePlanApi =
        retrofit.create(CommutePlanApi::class.java)
